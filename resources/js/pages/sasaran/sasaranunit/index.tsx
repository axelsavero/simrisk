// resources/js/pages/sasaran/sasaranunit/index.tsx
...
export default function Index({ sasaranUnits, flash }: IndexProps) {
    const [sortField, setSortField] = useState<'id_sasaran_unit' | 'kategori' | 'nama_dokumen' | 'nomor_dokumen' | 'tanggal_dokumen'>(
        'id_sasaran_unit',
    );
    ...
    const handleDelete = (id: number) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                router.delete(route('sasaran-unit.destroy', id));
            }
        });
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Data Sasaran Unit" />
            <div className="w-full px-6 py-8">
                <div className="mb-6 flex items-center justify-between">
                    <h2 className="text-2xl font-semibold">Data Sasaran Unit</h2>
                    {sortedData.length > 0 && (
                        <Link
                                            ...
                                            <tr key={item.id_sasaran_unit} className="hover:bg-gray-50">
                                                ...
                                                <td className="px-6 py-4 text-sm font-medium whitespace-nowrap">
                                                    <div className="flex items-center gap-2">
                                                        <Link
                                                            href={route('sasaran-unit.show', item.id_sasaran_unit)}
                                                        ...
                                                        <Link
                                                            href={route('sasaran-unit.edit', item.id_sasaran_unit)}
                                                        ...
                                                        <button
                                                            onClick={() => handleDelete(item.id_sasaran_unit)}
